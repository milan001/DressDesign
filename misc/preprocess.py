...
BIRD_DIR = cfg.DATASET_NAME


def load_filenames(data_dir):
    filepath = data_dir + 'filenames.txt' # training and testing
...
def load_bbox(data_dir):
    ...
    df_bounding_boxes=np.loadtxt(bbox_path,skiprows=2,usecols=range(1,5))
    #
...
#    filenames = df_filenames[1].tolist()
    ...
    for i in xrange(0, numImgs):
        ...
        bbox = df_bounding_boxes[i].tolist()
